...
var $author$project$Main$viewValidation = function (model) {
	return _Utils_eq(model.password, model.passwordAgain) ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Passwords do no match!')
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A4($author$project$Main$viewInput, 'passwordAgain', 'Re-enter password', model.passwordAgain, $author$project$Main$PasswordAgain),
